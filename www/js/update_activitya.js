...
//owner 100
var travel_expen=document.getElementById('travel_expen_100').value;
//alert(travel_expen+'travel_expen owner');
var actua_exp=document.getElementById('actua_exp_100').value;
//alert(actua_exp+'actua_exp owner');
var misc_e=document.getElementById('misc_e_100').value;
//alert(misc_e+'misc_e owner');
...
alert('bfr ajax');
$.ajax({
    url: "http://insurance.fourthforce.in/slim-insu-quest/insur-fir.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_seven_a="+insu_accident_nine_seven_a+"&insu_investiagtor_nine_seven_b="+insu_investiagtor_nine_seven_b+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&firc="+firc+"&fircmv="+fircmv+"&firccs="+firccs+"&fircps="+fircps+"&travel_expen_nine_seven="+travel_expen_nine_seven+"&actua_exp_nine_seven="+actua_exp_nine_seven+"&misc_e_nine_seven="+misc_e_nine_seven+"&user_id_su="+user_id_su,
...
$.ajax({
  ...
  //url: 'http://insurance.fourthforce.in/slim-insu-quest/index_verifd_insu.php?',
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
if(qualification_id == '99'){
	alert('99 if');
	//99 outside driver
var travel_expen_nine_nine=document.getElementById('travel_expen_nine_nine').value;
alert(travel_expen_nine_nine+'travel_expen_nine_nine outside driver');
var actua_exp_nine_nine=document.getElementById('actua_exp_nine_nine').value;
alert(actua_exp_nine_nine+'actua_exp_nine_nine outside driver');
...
$.ajax({
  url: "http://insurance.fourthforce.in/slim-insu-quest/insur-fir.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_nine_a="+insu_accident_nine_nine_a+"&insu_investiagtor_nine_nine_b="+insu_investiagtor_nine_nine_b+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&outdria="+outdria+"&outdrib="+outdrib+"&outdric="+outdric+"&outdrid="+outdrid+"&outdrie="+outdrie+"&outdrif="+outdrif+"&user_id_su="+user_id_su+"&travel_expen_nine_nine="+travel_expen_nine_nine+"&actua_exp_nine_nine="+actua_exp_nine_nine+"&misc_e_nine_nine="+misc_e_nine_nine,
  //url: 'http://insurance.fourthforce.in/slim-insu-quest/index_verifd_insu.php?',
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
...
$.ajax({
  type: "POST",
  url: "http://insurance.fourthforce.in/slim-insu-quest/insur.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_nine_a="+insu_accident_nine_nine_a+"&insu_investiagtor_nine_nine_b="+insu_investiagtor_nine_nine_b+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
if(qualification_id == '102'){
	alert('102 if');
	var travel_expen_102=document.getElementById('travel_expen_102').value;
alert(travel_expen_102+'travel_expen_102 claim');
var actua_exp_102=document.getElementById('actua_exp_102').value;
alert(actua_exp_102+'actua_exp_102 claim');
...
$.ajax({
//  url: "http://insurance.fourthforce.in/slim-insu-quest/insur.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_five_a="+insu_accident_nine_five_a+"&insu_inves_nine_five_b="+insu_inves_nine_five_b+"&insu_final_nine_five_c="+insu_final_nine_five_c+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state,
  url: "http://insurance.fourthforce.in/slim-insu-quest/insur-fir.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_one_zero_two_a="+insu_accident_one_zero_two_a+"&insu_investiagtor_one_zero_two_b="+insu_investiagtor_one_zero_two_b+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&claiquesa="+claiquesa+"&claiquesb="+claiquesb+"&claiquesc="+claiquesc+"&claiquesd="+claiquesd+"&claiquese="+claiquese+"&claiquesf="+claiquesf+"&claiquesg="+claiquesg+"&claiquesh="+claiquesh+"&claiquesi="+claiquesi+"&claiquesj="+claiquesj+"&claiquesk="+claiquesk+"&user_id_su="+user_id_su+"&travel_expen_102="+travel_expen_102+"&actua_exp_102="+actua_exp_102+"&misc_e_102="+misc_e_102,
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
if(qualification_id == '95'){
	alert('95 if');
	//accident
var travel_expen_95=document.getElementById('travel_expen_nine_five').value;
//alert(travel_expen_95+'travel_expen 95 accident');
var actua_exp_95=document.getElementById('actua_exp_nine_five').value;
//alert(actua_exp_95+'actua_exp 95 accident');
...
$.ajax({
  url: "http://insurance.fourthforce.in/slim-insu-quest/insur-fir.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_five_a="+insu_accident_nine_five_a+"&insu_inves_nine_five_b="+insu_inves_nine_five_b+"&insu_final_nine_five_c="+insu_final_nine_five_c+"&accquesa="+accquesa+"&accquesb="+accquesb+"&accquesc="+accquesc+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&user_id_su="+user_id_su+"&travel_expen_95="+travel_expen_95+"&actua_exp_95="+actua_exp_95+"&misc_e_95="+misc_e_95,
...
$.ajax({
  //url: "http://insurance.fourthforce.in/slim-insu-quest/insur.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_five_a="+insu_accident_nine_five_a+"&insu_inves_nine_five_b="+insu_inves_nine_five_b+"&insu_final_nine_five_c="+insu_final_nine_five_c+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state,
  url: "http://insurance.fourthforce.in/slim-insu-quest/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_six="+insu_final_one_zero_six+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&travel_expen="+travel_expen+"&actua_exp="+actua_exp+"&misc_e="+misc_es,
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://insurance.fourthforce.in/slim-insu-quest/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_six="+insu_final_one_zero_six+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
if(qualification_id == '101'){
	//alert('101');
	//101 insured
var travel_expen_insu=document.getElementById('travel_expen_insu').value;
alert(travel_expen_insu+'travel_expen_insu insured');
var actua_exp_insu=document.getElementById('actua_exp_insu').value;
alert(actua_exp_insu+'actua_exp_insu insured');
...
$.ajax({
  url: "http://insurance.fourthforce.in/slim-insu-quest/insur-fir.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_one="+insu_final_one_zero_one+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&insuria="+insuria+"&insurib="+insurib+"&insuric="+insuric+"&insurid="+insurid+"&insurie="+insurie+"&insurif="+insurif+"&user_id_su="+user_id_su+"&travel_expen_insu="+travel_expen_insu+"&actua_exp_insu="+actua_exp_insu+"&misc_e_insu="+misc_e_insu,
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://insurance.fourthforce.in/slim-insu-quest/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_one="+insu_final_one_zero_one+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
//var chatr='<div class="ui-grid-b" style="padding-top:5%;padding-bottom:5%"><div class="ui-block-a msg_grid_3"><span class="msg_span_3">'+date+'</span> <br><i class="zmdi zmdi-time zmd-fw" style="opacity: 0.5; padding-left:7%;    padding-top: 7%;margin-top:-10px"></i><span class="msg_span_3">'+time+'</span></div><div class="ui-block-b msg_grid_4">  <p class="msg_box msg_mid_bgg"><img src="http://insurance.fourthforce.in/insurance/super/'+activity_lok_obj.document+'" style="width:100px;height:80px;margin-left:25%" alt="Band"></p></div><div class="ui-block-c msg_grid_5"><img src="images/primary/chat-icon.png" alt="" style="padding: 0px 2px 1px 18px;"><p style="float: right;margin-right: 25px;margin-top: -5px;color:#54566B">hari</p></div></div>  '
//var chatr='<div class="ui-grid-b" style="padding-top:5%;padding-bottom:5%"><div class="ui-block-a msg_grid_3"><span class="msg_span_3">'+date+'</span> <br><i class="zmdi zmdi-time zmd-fw" style="opacity: 0.5; padding-left:7%;    padding-top: 7%;margin-top:-10px"></i><span class="msg_span_3 msg_span_3_new">'+time+'</span></div><div class="ui-block-b msg_grid_4">  <p class="msg_box msg_mid_bgg"><img src="http://insurance.fourthforce.in/insurance/super/'+activity_lok_obj.document+'" style="width:100px;height:80px;margin-left:25%" alt="Band"></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_c"><img src="images/primary/chat-icon.png" alt="" class=""><p class="">TVO</p></div></div>'
var chatr='<br><div class="ui-grid-b"  id="image"><div class="ui-block-a msg_grid_3" style="margin-top: 6%;"> <i class="zmdi zmdi-time zmd-fw" style="    opacity: 0.5; padding-left:7%;"></i><span class="msg_span_3">'+time+'</span><br><span class="msg_span_3">'+date+'</span><a href="#"  class="delete" id="'+activity_lok_obj.activity_log_id+'"><img src="images/primary/delete_icon1.png"  class="img_delete_icon" alt="" ></a>  </div><div class="ui-block-b msg_box msg_grid_4 msg_mid_bgg"><p class="msg_grid_p_1 "><a href="#popupPhotoPortrait" data-rel="popup" data-position-to="window" class="ui-btn ui-corner-all ui-shadow ui-btn-inline im" data-transition="fade" id="'+activity_lok_obj.document+'"><img src="http://insurance.fourthforce.in/super/'+activity_lok_obj.document+'"  class="imgsize imguirot" alt="" ></a></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_1"><img src="images/primary/chat-icona.png" alt="" class="p_img_grid" style="width:80px;"><br><p class="p_msg_grid">'+username_tvo+'</p></div></div> '
...
var imz='<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right" style="background-color:#BC3217;width:50px;height: 50px;">Close</a><img src="http://insurance.fourthforce.in/super/'+img_id+'" alt="Photo portrait" class="imgzz imguirot">'
$('.imj').append(imz);
});
...
$.ajax({
  type: "POST",
  url: "http://insurance.fourthforce.in/slim-insu-quest/delete.php?del_id="+del_id,
...
if(status == 'doc' && image !==''){
//alert('doc');
//var chatr='<div class="ui-grid-b"  id="image"><div class="ui-block-a msg_grid_3" style="margin-top: 6%;"> <i class="zmdi zmdi-time zmd-fw" style="    opacity: 0.5; padding-left:7%;"></i><span class="msg_span_3">'+time+'</span><br><span class="msg_span_3">'+date+'</span>  </div><div class="ui-block-b msg_box msg_grid_4 msg_mid_bgg"><p class="msg_grid_p_1 "><a href="#"  class=""><img src="http://insurance.fourthforce.in/insurance/super/'+activity_lok_obj.document+'" style="width:100px;height:80px;margin-left:25%" alt="Band"></a></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_1"><img src="images/use.png" alt="" class="p_img_grid" style="width:80px;"><br><p class="p_msg_grid">Tvo</p></div></div> '
//var chatr='<br><div class="ui-grid-b"  id="image"><div class="ui-block-a msg_grid_3" style="margin-top: 6%;"> <i class="zmdi zmdi-time zmd-fw" style="    opacity: 0.5; padding-left:7%;"></i><span class="msg_span_3">'+time+'</span><br><span class="msg_span_3">'+date+'</span><a href="#"  class="delete" id="'+activity_lok_obj.activity_log_id+'"><img src="images/primary/delete_icon1.png"  class="img_delete_icon" alt="" ></a>  </div><div class="ui-block-b msg_box msg_grid_4 msg_mid_bgg"><p class="msg_grid_p_1 "><a href="#popupPhotoPortrait" data-rel="popup" data-position-to="window" class="ui-btn ui-corner-all ui-shadow ui-btn-inline im" data-transition="fade" id="'+activity_lok_obj.activity_log_id+'"><img src="http://insurance.fourthforce.in/insurance/super/'+activity_lok_obj.document+'"  class="imgsize" alt="" ></a></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_1"><img src="images/primary/chat-icon.png" alt="" class="p_img_grid" style="width:80px;"><br><p class="p_msg_grid">'+username_tvo+'</p></div></div> '
var chatr='<br><div class="ui-grid-b"  id="image"><div class="ui-block-a msg_grid_3" style="margin-top: 6%;"> <i class="zmdi zmdi-time zmd-fw" style="    opacity: 0.5; padding-left:7%;"></i><span class="msg_span_3">'+time+'</span><br><span class="msg_span_3">'+date+'</span><a href="#"  class="delete" id="'+activity_lok_obj.activity_log_id+'"><img src="images/primary/delete_icon1.png"  class="img_delete_icon" alt="" ></a>  </div><div class="ui-block-b msg_box msg_grid_4 msg_mid_bgg"><p class="msg_grid_p_1 "><a href="#popupPhotoPortrait" data-rel="popup" data-position-to="window" class="ui-btn ui-corner-all ui-shadow ui-btn-inline im" data-transition="fade" id="'+activity_lok_obj.document+'"><img src="http://insurance.fourthforce.in/super/'+activity_lok_obj.document+'"  class="imgsize imguirot" alt="" ></a></p></div><div class="ui-block-c msg_grid_5 msg_grid_5_1"><img src="images/primary/chat-icona.png" alt="" class="p_img_grid" style="width:80px;"><br><p class="p_msg_grid">'+username_tvo+'</p></div></div> '
...
$.ajax({
  type: "POST",
url: "http://insurance.fourthforce.in/slim-insu-quest/sdoc.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&res="+res+"&qualification_id="+qualification_id+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://insurance.fourthforce.in/slim-insu-quest/chat.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&status_val_inpro="+status_val_inpro+"&remarkg="+remarkg+"&qualification_id="+qualification_id+"&username="+username+"&typofver="+typofver+"&pertobever="+pertobever+"&pertobeverlast="+pertobeverlast+"&task="+task+"&eeemail="+eeemail+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://insurance.fourthforce.in/slim-insu-quest/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
...
// $('#myPopupr').hide();
$.ajax({url: 'http://insurance.fourthforce.in/slim-insu-quest/count.php?region='+region+"&user_id="+user_id+"&state="+state,
